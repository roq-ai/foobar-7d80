...
export function useFooFindMany<
  T extends Prisma.fooFindManyArgs,
  R extends GetFindResult<Prisma.$fooPayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.fooFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useFooFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.foo.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useFooCount<T extends Prisma.fooCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.fooCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useFooCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.foo.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useFooFindManyWithCount<
  T extends Prisma.fooFindManyArgs,
  R extends { data: GetFindResult<Prisma.$fooPayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.fooFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useFooFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.foo.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useFooFindFirst<
  T extends Prisma.fooFindFirstArgs,
  R extends GetFindResult<Prisma.$fooPayload<DefaultArgs>, T>,
>(args?: Prisma.SelectSubset<T, Prisma.fooFindFirstArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useFooFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.foo.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
