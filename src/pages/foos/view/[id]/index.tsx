...
import { useFooFindFirst, useRoqClient } from 'lib/roq';

import { FooInterface } from 'interfaces/foo';

function FooViewPage() {
  ...
  const { data, error, isLoading } = useFooFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('foo', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/foos/edit/${id}`} passHref legacyBehavior>
                    <Button
