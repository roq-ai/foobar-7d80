  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="FooBar: Empowering Owners, Recruiters, and Freelancers. Streamline your hiring process, manage job applications, and create contracts seamlessly. All in one platform."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1521791136064-7986c2920216?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZWNydWl0bWVudHxlbnwwfHx8fDE2OTkyODMzNDV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`FooBar: Empowering Owners, Recruiters, and Freelancers. Streamline your hiring process, manage job applications, and create contracts seamlessly. All in one platform.`}
            </Text>
            <Box
